...
const tokenHTML = "<div><form id=\"myForm\"action=\"[APOS_URL]\" method=\"POST\"><input name=\"PAGE\" type=\"hidden\" value=\"TOKEN\">[PARAMETERS]</form><script>document.getElementById('myForm').submit();</script></div>";
